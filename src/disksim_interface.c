...
void disksim_interface_shutdown(
    struct disksim_interface *iface,
    double syssimtime) {
...
void disksim_interface_dump_stats(
    struct disksim_interface *iface,
    double syssimtime) {
    double curtime = syssimtime;
...
void disksim_interface_internal_event(
    struct disksim_interface *iface,
    double syssimtime,
    void *junk) {
    double curtime = syssimtime;
    ...
    while ((disksim->intq != NULL) && (disksim->intq->time <= (curtime + 0.0001))) {
...
void disksim_interface_request_arrive(
    struct disksim_interface *iface,
    double syssimtime,
