...
typedef enum {
   ...
   DISKSIM_SIMPLEDISK_TAPE_NUMBER_TRACKS,
   DISKSIM_SIMPLEDISK_TAPE_BLOCK_TRACKS,
   DISKSIM_SIMPLEDISK_READ_RATE,
   DISKSIM_SIMPLEDISK_WRITE_RATE,
   DISKSIM_SIMPLEDISK_SPOOLRATE,
   DISKSIM_SIMPLEDISK_HEAD_TIME
} disksim_simpledisk_param_t;

#define DISKSIM_SIMPLEDISK_MAX_PARAM		DISKSIM_SIMPLEDISK_HEAD_TIME
...
static struct lp_varspec disksim_simpledisk_params [] = {
   ...
   {"Access time", D, 1 },
   {"Tape number tracks", D, 1 },
   {"Tape block tracks", D, 1 },
   {"Read rate", D, 1 },
   {"Write rate", D, 1 },
   {"Spoolrate", D, 1 },
   {"Head time", D, 1 },
...
#define DISKSIM_SIMPLEDISK_MAX 16
